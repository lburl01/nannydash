...
ActiveRecord::Schema.define(version: 20161115185150) do
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.integer  "sitter_id"
    t.date     "date",        default: '2016-11-23',          null: false
    t.time     "start_time",  default: '2000-01-01 14:19:45', null: false
    t.time     "end_time",    default: '2000-01-01 17:19:45', null: false
    t.text     "notes"
