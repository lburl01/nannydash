...
ActiveRecord::Schema.define(version: 20161115185150) do
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.integer  "sitter_id"
    t.date     "date",        default: '2016-11-26',          null: false
    t.time     "start_time",  default: '2000-01-01 18:47:10', null: false
    t.time     "end_time",    default: '2000-01-01 21:47:10', null: false
    t.text     "notes"
