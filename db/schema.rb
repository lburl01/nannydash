...
ActiveRecord::Schema.define(version: 20161115185150) do
  ...
  create_table "jobs", force: :cascade do |t|
    ...
    t.integer  "sitter_id"
    t.date     "date",        default: '2016-11-21',          null: false
    t.time     "start_time",  default: '2000-01-01 15:49:46', null: false
    t.time     "end_time",    default: '2000-01-01 18:49:46', null: false
    t.text     "notes"
